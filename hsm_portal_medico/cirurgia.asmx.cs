...
//SELECT VALOR FROM PARAMETROS_SOFTWARE Where PARAMETRO='glb_str_STATUS_RESERVA'

//SELECT * FROM AGENDA_HOSPITAL WHERE MEDICOEXE=0 AND MEDICO IN(SELECT CODIGO FROM MEDICO WHERE TIPO='I')